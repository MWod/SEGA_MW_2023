...
def get_experiment_final_4():
    ...
    """
    dataset_path = p.parsed_sega_path / "ElasticShape_400_400_400_V2"
    validation_dataset_path = p.parsed_sega_path / "Shape_400_400_400"
    training_csv_path = p.parsed_sega_path / "elasticaug400_v2_training_dataset.csv"
    validation_csv_path = p.parsed_sega_path / "validation_dataset.csv"
